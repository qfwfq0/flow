...
;      call_procedure, 'ireadsc2',path,nsectionssav,mf,d3
    ...
    fileformat = '("dat/imf_bprofiles_",I0,".sav")'
...
help,bz
            bz=[bz,temporary(mf_z[0:*,*,*,*])]
            bt=[bt,temporary(mf_t[0:*,*,*,*])]
            br=[br,temporary(mf_r[0:*,*,*,*])]
            tt =  [tt,temporary(t[0:*])]
...
;#; end of the main for cycle
   ...
   print,'Sto salvando il file.. attendere.. imf_bprofiles.sav'


   save,tt,pror1,pror2,br,bt,bz,filename=save_file
