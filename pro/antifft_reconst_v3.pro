pro antifft_reconst_v3, path, str, d3, hel ,nth, nzz, itp0, itp1, deltaitp
...
;#; begin 3d part
  ...
  outfile = path+'dat/itp/'+strtrim(string(itp(q),format='(i0)'))+'/antifft_'+str+'_'+strtrim(string(nth,format='(i0)'))+'x'+strtrim(string(nzz,format='(i0)'))+'_m0_exp.sav'
  outfile = path+'dat/itp/'+strtrim(string(itp(q),format='(i0)'))+'/antifft_'+str+'_'+strtrim(string(nth,format='(i0)'))+'x'+strtrim(string(nzz,format='(i0)'))+'_m1_exp.sav'
  outfile = path+'dat/itp/'+strtrim(string(itp(q),format='(i0)'))+'/antifft_'+str+'_'+strtrim(string(nth,format='(i0)'))+'x'+strtrim(string(nzz,format='(i0)'))+'_all.sav'
print,outfile
...
;         if (in lt -25) then goto, jump
;        endif
;        if (im eq 1) then begin
;         if ((in lt -30) or (in gt 5)) then goto, jump
;        endif

;#; tolgo la parte di equilibrio
;        if (im eq 0) then begin
...
;#; solo modi fino a m=1
;         if (im gt 2) then goto, jump

;#; solo parte m=1 e no assialsimmetric
;        if (im eq 0) then begin
;         if (in lt -9) then goto, jump
;        endif
;        if (im eq 1) then begin
;         if ((in lt -13) or (in gt -3)) then goto, jump
;        endif

;#; Marco & Nicholas, solo modi m=0 considerati nella ricostruzione exp RFX-mod
;        if (im eq 0) then begin
;         if (in lt -9 or in eq -7 or in eq 0) then goto, jump
;        endif
;        if (im ge 1) then goto, jump
;#; Marco & Nicholas, solo modi m=1 considerati nella ricostruzione exp RFX-mod
;        if (im eq 0) then goto, jump
;        if (im eq 1) then begin
;         if (in lt -20 or in gt -6) then goto, jump
;        endif
;        if (im ge 2) then goto, jump
;#; Marco, solo parte di equilibrio
;        if (im ne 0) then goto, jump
;        if (im eq 0 and in ne 0) then goto, jump
